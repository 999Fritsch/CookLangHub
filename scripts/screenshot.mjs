...
const PAGES = [
  ...
  { name: "diagnostics", path: "/admin/index", needsSession: true },
  { name: "archive", path: "/recipes/filip/chili-sin-carne/archive", needsSession: true },
  { name: "delete", path: "/recipes/filip/chili-sin-carne/archive/delete", needsSession: true },
  { name: "cookbook-archive", path: "/cookbooks/filip/weeknight-dinners/archive", needsSession: true },
